...
import ChefDual from "../ui/chefDual.png";
...
const AdminHome = (props) => {
  ...
  const loggedInData = JSON.parse(localStorage.getItem("LOGGED_IN"));
    const loggedInAdmin = loggedInData?.payload?.AdminEmail;
    const adminName = loggedInAdmin ? loggedInAdmin.split("@")[0] : "Admin";
  ...
  return (
    <React.Fragment>
      ...
      <div className="container mt-3 text-center">
        <Card
          title={props.loggedInProfile + " (" + (loggedInAdmin || "Unknown Admin") + ")"}
          background="#293462"
          textColor="#ffffff"
        >
          <div className="row">
